...
<template>
    <svg v-bind="$attrs" v-if="variant === 'simple'" :width="size" :height="size" viewBox="20 20 60 60">
        <circle cx="50" cy="50" r="24" fill="none" stroke="#9ca3af" stroke-dasharray="113.0973 39.6991" stroke-width="6">
            <animateTransform attributeName="transform" dur="1s" keyTimes="0;1" repeatCount="indefinite" type="rotate" values="0 50 50;360 50 50"/>
        </circle>
    </svg>


    <svg v-bind="$attrs" v-if="variant === 'spartan'" :width="size" :height="size" viewBox="20 20 60 60">
        ...
        <circle cx="62.5" cy="71.65063509461096" :fill="backgroundColor" r="5">
            <animate
                attributeName="r"
                values="3;3;5;3;3"
                times="0;0.1;0.2;0.3;1"
        ...
        <circle cx="37.50000000000001" cy="71.65063509461098" :fill="backgroundColor" r="5">
            <animate
                attributeName="r"
                values="3;3;5;3;3"
                times="0;0.1;0.2;0.3;1"
        ...
        <circle cx="25" cy="50" :fill="backgroundColor" r="5">
            <animate
                attributeName="r"
                values="3;3;5;3;3"
                times="0;0.1;0.2;0.3;1"
        ...
        <circle cx="37.499999999999986" cy="28.349364905389038" :fill="backgroundColor" r="5">
            <animate
                attributeName="r"
                values="3;3;5;3;3"
                times="0;0.1;0.2;0.3;1"
        ...
        <circle cx="62.5" cy="28.349364905389034" :fill="backgroundColor" r="5">
            <animate
                attributeName="r"
                values="3;3;5;3;3"
                times="0;0.1;0.2;0.3;1"
