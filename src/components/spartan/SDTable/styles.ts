...
export const tableStyles = cva('w-full overflow-hidden', {
    variants: {
        borderless: cbv('', 'shadow rounded-2xl outline outline-1 outline-gray-300 dark:outline-white/10'),
    },
});
...
export const cellStyles = cva('relative first:pl-5 last:pr-5 p-3.5 text-sm text-left', {
    variants: {
        head: cbv('text-gray-900 font-semibold dark:text-gray-200', 'text-gray-500 dark:text-gray-400'),
