...
export const radioInputStyles = cva(
    'cursor-pointer rounded-full border border-gray-300 dark:border-white/10 dark:bg-white/5 text-spartan-primary-600 accent-spartan-primary-600 focus:ring-offset-0 focus:s-ring',
);
