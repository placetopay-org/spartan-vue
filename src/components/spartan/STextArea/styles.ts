...
export const textAreaStyles = cva(
    'block w-full rounded-lg bg-white dark:bg-white/5 py-1.5 text-gray-900 dark:text-gray-50 placeholder:text-gray-400 sm:text-sm sm:leading-6 outline-2 outline-offset-0 outline-transparent transition-[outline-offset,outline-color] duration-150',
    {
        variants: {
