...
export const checkboxInputStyles = cva(
    'cursor-pointer rounded border border-gray-300 dark:border-white/10 dark:bg-white/5 text-spartan-primary-600 accent-spartan-primary-600 outline-2 outline-offset-0 outline-transparent transition-[outline-offset,outline-color] duration-150 focus:ring-0 focus:ring-offset-0 focus:s-outline',
);
