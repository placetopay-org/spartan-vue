...
export const operatorsByFieldType = {
    ...
    single: {
        text: [...comparisonOperators, ...textOperators, ...existenceOperators] as (TComparisonOperator | TTextOperator | TExistenceOperator)[],
        number: [...comparisonOperators, ...existenceOperators] as (TComparisonOperator | TExistenceOperator)[],
        date: [...comparisonOperators, ...dateOperators, ...existenceOperators] as (TComparisonOperator | TDateOperator | TExistenceOperator)[],
    ...
    range: {
        ...
        date: [...rangeOperators, ...dateOperators, ...existenceOperators] as (TRangeOperator | TDateOperator | TExistenceOperator)[],
        amount: [...rangeOperators, ...existenceOperators] as (TRangeOperator | TExistenceOperator)[],
    },
    options: [...comparisonOperators, 'contains', 'notContains', ...existenceOperators] as (TComparisonOperator | Extract<TTextOperator, 'contains' | 'notContains'> | TExistenceOperator)[],
