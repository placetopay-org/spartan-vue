    ...
    >
        <template #reference>
            <button
                ...
                class="group focus:s-ring flex items-center gap-2 rounded-full border border-dashed border-gray-400 px-3 py-0.5 text-sm whitespace-nowrap text-gray-400 hover:border-gray-500 hover:text-gray-600 disabled:pointer-events-none disabled:opacity-50"
                @click="openPopover"
            >
            ...
            >
                ...
                <ul class="w-full">
                    ...
                    <li
                        ...
                        v-else
                        :key="item.id"
                        class="hover:text-spartan-primary-600 rounded-lg hover:bg-gray-50"
                    >
