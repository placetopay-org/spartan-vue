...
<template>
    <button
        ...
        type="button"
        :class="[
            's-focus group group group relative inline-flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:z-20 focus:outline-primary-300 active:bg-primary-50 active:text-primary-600',
