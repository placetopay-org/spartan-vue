...
<template>
    <component
        ...
        :class="[
            active ? 'bg-spartan-primary-100 text-spartan-primary-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100',
    ...
    >
        <component
            v-if="icon"
            :is="icon"
            :class="[active ? 'text-spartan-primary-500' : 'text-gray-400 group-hover:text-gray-500', '-ml-0.5 mr-2 h-5 w-5']"
            aria-hidden="true"
        />
        <slot />
    </component>
