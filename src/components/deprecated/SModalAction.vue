<template>
    <SModalLayout v-bind="$attrs">
        <div class="p-6">
            <div>
                <div :class="[iconWrapperClasses, 'mx-auto flex h-12 w-12 items-center justify-center rounded-full']">
...
import { CheckIcon, ExclamationCircleIcon, ChatBubbleBottomCenterTextIcon } from '@heroicons/vue/24/outline';
