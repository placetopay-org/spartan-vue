...
<template>
    <Listbox as="div" v-slot="{ open }" v-model="model" :disabled="disabled" class="relative">
        ...
        >
            <ListboxOptions
                class="absolute w-full mt-1 overflow-auto text-base bg-white rounded-lg shadow-lg min-w-56 min-h-56 max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
            >
