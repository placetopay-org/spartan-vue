...
const classes = computed(() => [
  ...
  props.outline ? 'outline outline-1 -outline-offset-1' + colorOption[props.color].styleClass.outline : colorOption[props.color].styleClass.solid,
...
<style scoped>
.badge-square-enter-active {
  animation: 150ms cubic-bezier(0.55, 0.055, 0.675, 0.19) badge-square;
}
.badge-square-leave-active {
  animation: 150ms cubic-bezier(0.55, 0.055, 0.675, 0.19) badge-square reverse;
}

.badge-circle-enter-active {
  animation: 150ms cubic-bezier(0.55, 0.055, 0.675, 0.19) badge-circle;
}
.badge-circle-leave-active {
  animation: 150ms cubic-bezier(0.55, 0.055, 0.675, 0.19) badge-circle reverse;
}
