...
<template>
  <button
    ...
    type="button"
    :class="[
      'group text-sm font-medium inline-flex items-center justify-center gap-2 group relative group py-2 px-3 text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:z-20 s-focus focus:outline-primary-300 active:bg-primary-50 active:text-primary-600',
