...
(async () => {
    ...
    components.forEach((component) => {
        fs.cpSync(
            `./dist/types/components/spartan/${component}/index.d.ts`,
            `./dist/components/${component}/index.d.ts`,
        );
        fs.cpSync(
            `./dist/types/components/spartan/${component}/${component}.vue.d.ts`,
            `./dist/components/${component}/${component}.vue.d.ts`,
        );
        if (fs.existsSync(`./dist/types/components/spartan/${component}/types.d.ts`))
            fs.cpSync(
                `./dist/types/components/spartan/${component}/types.d.ts`,
                `./dist/components/${component}/types.d.ts`,
            );
    });
