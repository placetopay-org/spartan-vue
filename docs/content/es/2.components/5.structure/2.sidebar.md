...
Usa el slot `footer` para agregar contenido fijado en la parte inferior del sidebar, como informacion del perfil de usuario o un boton de cierre de sesion.
...
Combina multiples componentes `SSidebarItemGroup` con `SSidebarSeparator` para crear estructuras de navegacion ricas y multinivel.
