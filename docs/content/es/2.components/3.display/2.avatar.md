---
title: Avatar
description: Un componente para mostrar avatares de usuario con iniciales, imágenes, indicadores, múltiples tamaños y soporte para modo oscuro.
navigation:
...
El componente `SAvatar` muestra un avatar de usuario con soporte para modo oscuro. Muestra iniciales derivadas de la prop `name`, o una imagen cuando se proporciona `src`.
...
El indicador también funciona cuando se muestra una imagen.
