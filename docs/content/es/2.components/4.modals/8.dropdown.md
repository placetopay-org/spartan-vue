...
Usa la prop `variant` con el valor `compact` para un dropdown más compacto sin líneas divisorias entre items. Los items usan 8px de padding vertical en lugar de 12px.
...
|------|------|---------|-------------|
| `variant` | `'default' \| 'compact'` | `'default'` | Variante visual. Usa `compact` para un espaciado más compacto sin divisores |
