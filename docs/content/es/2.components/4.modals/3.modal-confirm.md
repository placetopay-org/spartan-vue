...
Este componente envuelve **SModalCard**. Consultalo para props compartidas como `icon`, `iconColor`, `iconType`, `closable`, `responsive` y `preventClose`.
::
...
| `cancel` | - | Emitido cuando se hace clic en el boton de cancelar |
