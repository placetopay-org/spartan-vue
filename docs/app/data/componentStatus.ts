...
const componentsByCategory: Record<ComponentCategory, ComponentStatusEntry[]> = {
    ...
    selectors: [
        { name: 'SCheckbox', typescript: true, tests: 94, docs: 'complete' },
        { name: 'SRadio', typescript: true, tests: 100, docs: 'complete' },
        { name: 'SRadioGroup', typescript: true, tests: 100, docs: 'complete' },
        { name: 'SSwitch', typescript: true, tests: 100, docs: 'complete' },
        { name: 'SSelector' },
        { name: 'SMultiSelector' },
    ],
    display: [
