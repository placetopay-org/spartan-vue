...
<template>
    <SButton @click="open = true">Open Modal Left</SButton>

    <SModalLeft :open="open" @close="open = false" @backdrop-click="open = false">
        <div class="h-full w-80 bg-white p-6">
            <h2 class="text-lg font-semibold text-gray-900">Side Panel</h2>
            <p class="mt-2 text-sm text-gray-600">This panel slides in from the left side of the screen.</p>
            <div class="mt-4">
